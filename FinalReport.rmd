...
The drug is only `r DrugUsereff `% effective on drugusers, which means the drug can be effective. The confidence interval is from `r DrugUserefflowereff ` to `r DrugUsereffuppereff`. According to these results, I would recommend drugusers to receive the covid-19 study drug.
